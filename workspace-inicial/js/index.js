...
function checkAuthentication() {
    ...
    if (!isLoggedIn) {
        window.location.href = "workspace-inicial/login.html"; // Redirigimos al usuario a la página de inicio de sesión
    }
}
...
function cerrarSesion() {
    ...
    window.location.href = "workspace-inicial/login.html"; // Redirigir al inicio de sesión
  }
